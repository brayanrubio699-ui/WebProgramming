...
```properties
# Configuración de la base de datos (usando H2 para el ejemplo)
...
app.jwt.secret=miClaveSecretaSuperSeguraQueDebeSerMasLargaEnProduccion
...
public class SecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        // Para permitir la consola de H2 (solo para desarrollo)
